...
pizzaJson.map((item, index) => {
    ...
    // PREÇO MUDAR DE ACORDO COM O TAMANHO DA PIZZA
...
//EVENTOS DO MODAL
let close = document.querySelector('.pizzaInfo--cancelButton')
let closeMobile = document.querySelector('.pizzaInfo--cancelMobileButton')
